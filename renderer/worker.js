...
function convertObjectToData(obj) {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        const newItem = {
            ...
            imageHtml: getFileIcon(item, null, iconsData),
        };
        if (item.children) {
...
// Get file icon
function getFileIcon(item, isEditorIcon, iconsData) {
    let iconId = null;
    let extension = null;
    ...
    if (iconId[extension]) {
        ...
        let iconChar = 0;
        if (iconDefinition) {
            iconChar = iconDefinition.fontCharacter.replace(/\\/g, '');
            let fontId = 'octicons';
...
//             imageHtml: getFileIcon(currentItem, null, iconsData),
//         };
//         if (currentItem.children) {
//             // Push child items to the stack
//             stack.push({ parent: newItem, children: currentItem.children });
//         }
//         data.push(newItem);
//     }
//
...
//         let childItems = Object.values(children);
//         childItems.sort((a, b) => {
//             if (a.type === 'directory' && b.type !== 'directory') {
//                 return -1;
//             } else if (a.type !== 'directory' && b.type === 'directory') {
