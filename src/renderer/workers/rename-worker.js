...
self.addEventListener('message', async (event) => {
    ...
    if (objectToUpdate?.id) {
        objectToUpdate.text = passedData.newData.text;
        objectToUpdate.filePath = passedData.newData.filePath;
        objectToUpdate.extension = passedData.newData.extension;
        objectToUpdate.imageHtml = passedData.newData.imageHtml;
    }
